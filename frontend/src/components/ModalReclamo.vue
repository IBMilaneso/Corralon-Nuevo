      ...
      <div class="modal-body">
        ...
        <form @submit.prevent="enviarFormulario" class="formulario-reclamo">
          <div class="campo">
            ...
            <input type="text" v-model="rfc" placeholder="Ej. ABCD901234EFG" required maxlength="13">
          </div>

          <div class="campo">
            <label>Número de Licencia:</label>
            <input type="text" v-model="licencia" placeholder="Ej. A12345678" required>
          </div>
          ...
          <div class="acciones">
            ...
            <button type="submit" class="btn-primario">Solicitar Trámite</button>
          </div>
        </form>
      </div>
...
.formulario-reclamo input:focus {
  outline: none;
  border-color: #3b82f6;
